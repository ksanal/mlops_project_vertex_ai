...
bucket = storage_client.bucket("mlops-pro2")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "dh-gcp-infra-sandbox.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://mlops-pro2/bank-campaign-training-data.csv"
    model_name = 'xgboost'
